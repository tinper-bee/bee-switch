	    ...
	    Demo1.prototype.render = function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                _beeLayout.Col,
	                { sm: 2 },
	                _react2['default'].createElement(_src2['default'], { defaultChecked: this.state.defaultChecked, onChange: this.onChange })
	            )
	        );
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo3 = function (_Component) {
	    ...
	    Demo3.prototype.onChange = function onChange(e) {
	        this.setState({
	            'switch': '' + e,
	            checked: !this.state.checked
	        });
	    ...
	    Demo3.prototype.render = function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                _beeLayout.Col,
	                { sm: 2 },
	                _react2['default'].createElement(_src2['default'], { defaultChecked: this.state.checked, onChange: this.onChange, checkedChildren: 'on', unCheckedChildren: 'off' })
	            ),
	            _react2['default'].createElement(
	                _beeLayout.Col,
	                { sm: 2 },
