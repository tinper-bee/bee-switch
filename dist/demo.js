...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo4 = function (_Component) {
	  ...
	  function Demo4(props) {
	    ...
	    _this.onChange = function () {
	      _this.setState({
	        defaultDisabled: !_this.state.defaultDisabled
	      });
	    };
	
	    _this.onConsoleLog = function (x) {
	      console.log(x);
	    };
	  ...
	  Demo4.prototype.render = function render() {
	    return _react2["default"].createElement(
	      ...
	      _react2["default"].createElement(
	        _beeLayout.Col,
	        { sm: 2 },
	        _react2["default"].createElement(_src2["default"], { disabled: this.state.defaultDisabled })
	      ),
	      _react2["default"].createElement(
	        _beeLayout.Col,
	        { sm: 2 },
